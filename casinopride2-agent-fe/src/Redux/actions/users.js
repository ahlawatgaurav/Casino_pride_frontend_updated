...
export const getagentDiscountsList =
  (token, userId, callback) => async (dispatch) => {
    api.CORE_PORT.get(`core/agentDiscounts?userId=${userId}`, {
      headers: { AuthToken: token },
    })
      .then((response) => {
        if (response.data?.Details) {
...
export const AddagentDiscountsFn =
  (data, token, callback) => async (dispatch) => {
    api.CORE_PORT.post("/core/agentDiscounts", data, {
      headers: { AuthToken: token },
    })
      .then((response) => {
...
export const EditagentDiscountsFn =
  (data, token, callback) => async (dispatch) => {
    api.CORE_PORT.put("/core/agentDiscounts", data, {
      headers: { AuthToken: token },
    })
      .then((response) => {
...
export const uploadAgentDiscountQRFileFn =
  (data, token, callback) => async (dispatch) => {
    api.CORE_PORT.post("/core/uploadAgentDiscountQRFile", data, {
...
export const shortenUrl = (data, callback) => async (dispatch) => {
...
export const fetchFutureBookingDates = (callback) => async (dispatch) => {
  api.CORE_PORT.get(`/core/futureBookingDate`)
    .then((response) => {
      console.log("Fetch Future bookning dates ->", response.data);
      if (response.data) {
        console.log(response.data);
        callback({
          status: true,
